 ...
 * Pure HTML5 Audio Engine from v17 — 100% reliable sound output on Mobile & Desktop.
 */
...
// ── No-op EQ compatibility exports for components ─────────────────────────────
export const EQ_PRESETS = {
  'Flat': { name: 'Flat (Default)', gains: [0, 0, 0, 0, 0], icon: '🎵', desc: 'Natural balanced sound' },
};
export function setEqPreset() {}
export function getCurrentEqPreset() { return 'Flat'; }
